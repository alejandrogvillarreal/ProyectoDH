            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td>   </td>
                        <td><a href="index.html"><button type="button" class="btn btn-default">Seguir comprando</button></a></td>
                        <td><a href="index.html"><button type="button" class="btn btn-success ">Comprar</button></a></td>
                    </tr>
                </tbody>
            </table>
        </div>
